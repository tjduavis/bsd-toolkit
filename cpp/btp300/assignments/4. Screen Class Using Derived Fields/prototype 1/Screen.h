...
class Box : public Field {
	...
	public:
	Box(int rowB, int colB, int widthBox, int heightBox, const char* border = "+-+|+-+|")
	: Field(rowB, colB, widthBox, "", false) {
		rowBox = rowB;
		colBox = colB;
...
class DVField : virtual public VField {
	int rowDV;
	int colDV;
	int lenDV;
	int decDV;
