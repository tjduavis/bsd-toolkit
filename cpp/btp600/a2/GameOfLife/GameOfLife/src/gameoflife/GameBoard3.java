 ...
 * GameBoard3.java
 *
 * Created on 2007년 4월 7일 (토), 오전 9:16
 */
package gameoflife;
...
public class GameBoard3 extends javax.swing.JFrame {
    ...
    public void initGameBoard() {
        ...
        myTimer = new Timer(defaultGameSpeed, new ActionListener() {
           public void actionPerformed (ActionEvent evt) {
               if (keepGenerating) myGameBoard.nextGeneration();
               refreshGameBoard();
           } 
        });
        myTimer.start();
    ...
    private void refreshGameBoard() {
        //drawGrids();
        lblCounter.setText(Integer.toString(myGameBoard.getCount()));
        int cellsRow = myGameBoard.gameBoardRow();
        int cellsCol = myGameBoard.gameBoardCol();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GameBoard3 myGameBoard = new GameBoard3();
