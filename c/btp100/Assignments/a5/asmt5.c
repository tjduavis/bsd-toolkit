/*
*  Assignment 5: Version 1.00
*  2005 Sunrise
*  tjduavis5.c
*       Program for grocery stores that produces an itemized
*       bill of sale that meets the forthcoming 2005 point
*       of sale standards.
*       UPGRADE:        - to admit voiding and 
*                       - to display alphabetic descriptions of the items purchased. 
*
*  Programmer: Timothy Duavis
*  Due Date: Nov 28,04
*  Last Modified: Nov 28,2004
*/
...
/***Local Variables***/
	...
	if(count==2)
	{
		strcpy(descriptor[x], descriptor[duplicate]);
